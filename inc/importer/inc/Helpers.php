...
class Helpers {
	...
	public static function get_log_path() {
		...
		$upload_path = apply_filters( 'pt-ocdi/upload_file_path', trailingslashit( $upload_dir['basedir'] ) );

		$log_path = $upload_path . apply_filters( 'pt-ocdi/log_file_prefix', 'busify_log_file_' ) . self::$demo_import_start_time . apply_filters( 'pt-ocdi/log_file_suffix_and_file_extension', '.txt' );
