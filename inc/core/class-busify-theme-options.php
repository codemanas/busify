...
class Busify_Theme_Options {
	...
	static function load_defaults() {
		$defaults = array(
			...
			'field-global-body-bg-color'                      => '#e9ecef',
			'field-global-text-color'                         => '#000000',
			'field-global-theme-color'                        => '#254099',
			'field-global-link-color'                         => '#254099',
			'field-global-hover-link-color'                   => '#0085ba',
			'field-global-button-color'                       => '#254099',
			'field-global-button-tet-color'                   => '#ffffff',
			'field-global-button-hover-color'                 => '#0085ba',
			'field-global-button-hover-text-color'            => '#ffffff',
			'field-button-vertical-padding'                   => '10',
			'field-button-horizontal-padding'                 => '20',
			'field-button-border'                             => '0',
			'field-global-button-border-color'                => '',
