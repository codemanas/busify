	...
	public function register_configuration( $configs ) {
		...
		$global_fields = array(
			...
			array(
				...
				'label'     => __( 'Body Background Color', CODEMANAS_THEME_DOMAIN ),
			...
			array(
				'category'  => 'field',
				'type'      => 'color',
				'settings'  => 'field-global-text-color',
				'label'     => __( 'Text Color', CODEMANAS_THEME_DOMAIN ),
				'section'   => 'section-global-colors',
				'default'   => $black_color,
				'transport' => 'auto',
				'choices'   => [
				...
				'output'    => [
					[
						'element'  => '.busify-no-builder-page-template .entry-content p, .busify-recent-post-excerpt',
						'property' => 'color'
					]
				],
			),
			array(
				...
				'label'     => __( 'Theme Color', CODEMANAS_THEME_DOMAIN ),
				'section'   => 'section-global-colors',
				...
				'output'    => [
					[
						'element'  => '.woocommerce span.onsale, .comment-wrapper .comments-title-section span, .busify-sidebar .widget .widget-title:after, .double-bounce1, .double-bounce2',
						'property' => 'background-color'
					],
					[
						'element'  => 'fa, blockquote::before',
						'property' => 'color'
					],
					[
						'element'  => '.comment-wrapper .comments-title-section',
			...
			array(
				'category'  => 'field',
				'type'      => 'color',
				'settings'  => 'field-global-link-color',
				'label'     => __( 'Link Color', CODEMANAS_THEME_DOMAIN ),
				'section'   => 'section-global-colors',
				'default'   => $primary_color,
				'transport' => 'auto',
				'choices'   => [
			...
			array(
				'category'  => 'field',
				'type'      => 'color',
				'settings'  => 'field-global-hover-link-color',
